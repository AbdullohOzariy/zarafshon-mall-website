      ...
      <div style={{ maxWidth: 1280, margin: "0 auto" }}>
            ...
            >
              ...
              <div
                style={{
                  ...
                  height: "100%",
                  background:
                    "linear-gradient(to bottom, #B08D57, transparent)",
                  borderRadius: "12px 0 0 12px",
                }}
              />

              <div style={{ marginBottom: 16, color: "#B08D57" }}>
                {icons[i]}
              </div>
        ...
        <div
          style={{
            ...
            borderRadius: 16,
            background:
              "linear-gradient(135deg, rgba(176,141,87,0.15) 0%, rgba(176,141,87,0.05) 100%)",
